    ...
    render() {
        ...
        <div>
            <ol id="orderProcess">
                ...
                <li class="current"><span className="step-number">2</span>Details &amp; Submit</li>
            ...
            <form method="post">
                <div className="row">
                    <div className="col-3">
                        <img src="~/Images/Products/Thumbnails/@Model.Product.ImageName" className="img-fluid img-thumbnail" alt="Image of product"/>
                    </div>
                    <div className="col-9">
                        <ul className="orderPageList" data-role="listview">
                            ...
                            <li className="quantity">
                                <div className="form-group row">
                                    ...
                                    <input className="form-control form-control-sm"/>
                                    x
                                    <span className="order-calc" id="orderPrice">$</span>
                                    =
